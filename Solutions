...
--SELECT * FROM zoos
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (1, 'zoológico de Calimio', 100000, 700000, 1);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (2, 'zoológico Matecaña', 110000, 720000, 2);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (3, 'zoológico de Barranquilla', 160000, 80000, 3);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (4, 'Parque de las Leyendas', 970000, 400000, 4);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (5, 'zoologico UNSAAC', 120000, 740000, 5);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (6, 'Temaiken Bioparque', 300000, 900000, 6);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (7, 'zoológico de Batán', 250000, 500000, 7);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (8, 'zoológico de San Diego', 1000000, 2000000, 8);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (9, 'Aquarium de Madrid', 600000, 1400000, 9);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (10, 'zoológico Arignar Anna', 800000, 300000, 10);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (11, 'zoológico Asahiyama', 400000, 250000, 11);
--INSERT INTO zoos (id, name, area, budget, city_id) VALUES (12, 'zoológico Taronga', 1200000, 700000, 12);
